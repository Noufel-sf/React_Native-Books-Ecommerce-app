...
export const BOOKS: Book[] = [
  ...
  {
    id: 'harry-potter-complete-set',
    title: 'Harry Potter Series Complete Set',
    subtitle: 'Special Edition Boxed Set',
    author: 'J.K. Rowling',
    originalYear: 2007,
    ...
    language: 'English',
    availableFormats: ['Hardcover', 'Paperback', 'E-Book'],
    description: 'The complete set of all seven Harry Potter books, detailing the adventures of the young wizard Harry Potter and his friends Hermione Granger and Ron Weasley.',
